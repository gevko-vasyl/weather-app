...
it('should render ForecastCarousel with given data', () => {
  render(<ForecastCarousel weather={mock} />);
  const celsius = screen.getByText(convertToCelsius(mock.list[1].main.temp));
